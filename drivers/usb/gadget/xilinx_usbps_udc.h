/*
 * Xilinx PS USB Device Controller Driver Header file.
 *
 * Copyright (C) 2011 Xilinx, Inc.
 *
 * This file is based on fsl_usb2_udc.h file with few minor modifications
...
/*
 * xusbps USB device/endpoint management registers
 */
#ifndef __XILINX_XUSBPS_UDC_H
#define __XILINX_XUSBPS_UDC_H
...
#define  OTGSC_CTRL_HAAR                      0x00000004
#define  OTGSC_CTRL_OTG_TERM                  0x00000008
#define  OTGSC_CTRL_DATA_PULSING              0x00000010
#define  OTGSC_CTRL_HADP                      0x00000040
#define  OTGSC_CTRL_HABA                      0x00000080
...
static inline int xusbps_udc_clk_init(struct platform_device *pdev)
{
	return 0;
}
static inline void xusbps_udc_clk_finalize(struct platform_device *pdev)
{
}
static inline void xusbps_udc_clk_release(void)
{
}
