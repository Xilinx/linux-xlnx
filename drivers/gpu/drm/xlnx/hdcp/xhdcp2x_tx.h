...
#define HDCP2X_TX_HDCPPORT_M_OFFSET		0x2B0
#define HDCP2X_TX_HDCPPORT_R_TX_OFFSET			0x000
#define HDCP2X_TX_HDCPPORT_TX_CAPS_OFFSET		0x008
#define HDCP2X_TX_HDCPPORT_CERT_RX_OFFSET		0x00B
#define HDCP2X_TX_HDCPPORT_R_RX_OFFSET			0x215
#define HDCP2X_TX_HDCPPORT_RX_CAPS_OFFSET		0x21D
#define HDCP2X_TX_HDCPPORT_E_KPUB_KM_OFFSET		0x220
#define HDCP2X_TX_HDCPPORT_E_KH_KM_OFFSET		0x2A0
#define HDCP2X_TX_HDCPPORT_H_PRIME_OFFSET		0x2C0
#define HDCP2X_TX_HDCPPORT_E_KH_KM_PAIRING_OFFSET	0x2E0
#define HDCP2X_TX_HDCPPORT_R_N_OFFSET			0x2F0
#define HDCP2X_TX_HDCPPORT_L_PRIME_OFFSET		0x2F8
#define HDCP2X_TX_HDCPPORT_E_DKEY_KS_OFFSET		0x318
#define HDCP2X_TX_HDCPPORT_R_IV_OFFSET			0x328
#define HDCP2X_TX_HDCPPORT_RX_INFO_OFFSET		0x330
#define HDCP2X_TX_HDCPPORT_SEQ_NUM_V_OFFSET		0x332
#define HDCP2X_TX_HDCPPORT_V_PRIME_OFFSET		0x335
#define HDCP2X_TX_HDCPPORT_RCVR_ID_LST_OFFSET		0x345
#define HDCP2X_TX_HDCPPORT_RCVR_ID_LST_MAX_SIZE		155
#define HDCP2X_TX_HDCPPORT_V_OFFSET			GENMASK(9, 5)
#define HDCP2X_TX_HDCPPORT_SEQ_NUM_M_OFFSET		GENMASK(9, 4)
#define HDCP2X_TX_HDCPPORT_K_OFFSET			0x3F3
#define HDCP2X_TX_HDCPPORT_STREAM_ID_TYPE_OFFSET	0x3F5
#define HDCP2X_TX_HDCPPORT_STREAM_ID_TYPE_SIZE		2
#define HDCP2X_TX_HDCPPORT_M_PRIME_OFFSET		0x473
#define HDCP2X_TX_HDCPPORT_RX_STATUS_OFFSET		0x493
#define HDCP2X_TX_HDCPPORT_TYPE_VALUE_OFFSET		0x494
#define HDCP2X_TX_HDCPPORT_VERSION_OFFSET		0x50
#define HDCP2X_TX_HDCPPORT_RX_CAPS_OFFSET		0x21D
