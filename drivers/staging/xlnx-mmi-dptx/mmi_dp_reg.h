...
#define AUD_CONFIG1_DATA_IN_EN_8CH		GENMASK(4, 1)
#define AUD_CONFIG1_DATA_WIDTH_16		BIT(9)
#define AUD_CONFIG1_NUM_CH_8			GENMASK(14, 12)
#define AUD_CONFIG1_TS_VER_SHIFT		24
/* As per DP 1.3 standard, this should be h'12 */
#define AUD_CONFIG1_TIMESTAMP_VER		0x12
#define AUD_CONFIG1_AUDIO_CLK_MULT_FS_SHIFT	30
#define AUD_CONFIG1_AUDCLK_512FS		0
#define SDP_VERTICAL_CTRL			0x0500
#define SDP_VER_CTRL_EN_TIMESTAMP		BIT(0)
#define SDP_VER_CTRL_EN_STREAM			BIT(1)
#define SDP_VER_CTRL_FIXED_PRIO_ARB		BIT(31)
#define SDP_HORIZONTAL_CTRL			0x0504
#define SDP_HORI_CTRL_EN_TIMESTAMP		BIT(0)
#define SDP_HORI_CTRL_EN_STREAM			BIT(1)
#define SDP_HORI_CTRL_FIXED_PRIO_ARB		BIT(31)
