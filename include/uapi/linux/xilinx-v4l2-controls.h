...
/*
 * Xilinx Video Preprocess IP
 */

/* Base ID */
#define V4L2_CID_XILINX_PREPROCESS			(V4L2_CID_USER_BASE + 0xc200)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_ALPHA_1	(V4L2_CID_XILINX_PREPROCESS + 1)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_ALPHA_2	(V4L2_CID_XILINX_PREPROCESS + 2)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_ALPHA_3	(V4L2_CID_XILINX_PREPROCESS + 3)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_ALPHA_4	(V4L2_CID_XILINX_PREPROCESS + 4)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_BETA_1	(V4L2_CID_XILINX_PREPROCESS + 5)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_BETA_2	(V4L2_CID_XILINX_PREPROCESS + 6)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_BETA_3	(V4L2_CID_XILINX_PREPROCESS + 7)
#define V4L2_CID_XILINX_PREPROCESS_PARAM_BETA_4	(V4L2_CID_XILINX_PREPROCESS + 8)
