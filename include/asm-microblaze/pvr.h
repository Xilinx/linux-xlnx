...
#define PVR_INTERRUPT_IS_EDGE(pvr)       (pvr.pvr[2] & PVR2_INTERRUPT_IS_EDGE_MASK)
#define PVR_EDGE_IS_POSITIVE(pvr)        (pvr.pvr[2] & PVR2_EDGE_IS_POSITIVE_MASK)
...
#define PVR_OPCODE_0x0_ILLEGAL(pvr)      (pvr.pvr[2] & PVR2_OPCODE_0x0_ILLEGAL_MASK)
#define PVR_UNALIGNED_EXCEPTION(pvr)     (pvr.pvr[2] & PVR2_UNALIGNED_EXCEPTION_MASK)
#define PVR_ILL_OPCODE_EXCEPTION(pvr)    (pvr.pvr[2] & PVR2_ILL_OPCODE_EXCEPTION_MASK)
#define PVR_IOPB_BUS_EXCEPTION(pvr)      (pvr.pvr[2] & PVR2_IOPB_BUS_EXCEPTION_MASK)
#define PVR_DOPB_BUS_EXCEPTION(pvr)      (pvr.pvr[2] & PVR2_DOPB_BUS_EXCEPTION_MASK)
#define PVR_DIV_ZERO_EXCEPTION(pvr)      (pvr.pvr[2] & PVR2_DIV_ZERO_EXCEPTION_MASK)
...
#define PVR_NUMBER_OF_PC_BRK(pvr)        ((pvr.pvr[3] & PVR3_NUMBER_OF_PC_BRK_MASK) >> 25)
#define PVR_NUMBER_OF_RD_ADDR_BRK(pvr)   ((pvr.pvr[3] & PVR3_NUMBER_OF_RD_ADDR_BRK_MASK) >> 19)
#define PVR_NUMBER_OF_WR_ADDR_BRK(pvr)   ((pvr.pvr[3] & PVR3_NUMBER_OF_WR_ADDR_BRK_MASK) >> 13)
#define PVR_FSL_LINKS(pvr)               ((pvr.pvr[3] & PVR3_FSL_LINKS_MASK) >> 7)

#define PVR_ICACHE_ADDR_TAG_BITS(pvr)    ((pvr.pvr[4] & PVR4_ICACHE_ADDR_TAG_BITS_MASK) >> 26)
...
#define PVR_ICACHE_LINE_LEN(pvr)         (1 << ((pvr.pvr[4] & PVR4_ICACHE_LINE_LEN_MASK) >> 21))
#define PVR_ICACHE_BYTE_SIZE(pvr)        (1 << ((pvr.pvr[4] & PVR4_ICACHE_BYTE_SIZE_MASK) >> 16))

#define PVR_DCACHE_ADDR_TAG_BITS(pvr)    ((pvr.pvr[5] & PVR5_DCACHE_ADDR_TAG_BITS_MASK) >> 26)
...
#define PVR_DCACHE_LINE_LEN(pvr)         (1 << ((pvr.pvr[5] & PVR5_DCACHE_LINE_LEN_MASK) >> 21))
#define PVR_DCACHE_BYTE_SIZE(pvr)        (1 << ((pvr.pvr[5] & PVR5_DCACHE_BYTE_SIZE_MASK) >> 16))
...
#define PVR_MSR_RESET_VALUE(pvr)         (pvr.pvr[11] & PVR11_MSR_RESET_VALUE_MASK)
