...
#ifndef XPAR_OPB_DDR_0_MEM0_BASEADDR
#define XPAR_OPB_DDR_0_MEM0_BASEADDR	(XPAR_ERAM_START)
#define XPAR_OPB_DDR_0_MEM0_HIGHADDR	(XPAR_ERAM_START + XPAR_ERAM_SIZE - 1)
#endif

#define DDR_SDRAM_BASEADDR	(XPAR_OPB_DDR_0_MEM0_BASEADDR)
#ifdef CONFIG_XILINX_UNCACHED_SHADOW
#define DDR_SDRAM_HIGHADDR	((XPAR_OPB_DDR_0_MEM0_HIGHADDR + 1 - XPAR_OPB_DDR_0_MEM0_BASEADDR) / 2))
#else
#define DDR_SDRAM_HIGHADDR	(XPAR_OPB_DDR_0_MEM0_HIGHADDR)
#endif
...
#define XPAR_INTC_MAX_NUM_INTR_INPUT (XPAR_OPB_INTC_0_NUM_INTR_INPUTS)
#define XPAR_INTC_0_KIND_OF_INTR (XPAR_OPB_INTC_0_KIND_OF_INTR)
#endif

#ifdef XPAR_OPB_UARTLITE_0_BASEADDR
#define XPAR_UART_0_BASEADDR		(XPAR_OPB_UARTLITE_0_BASEADDR)
#define XPAR_UART_0_INTR		(XPAR_OPB_INTC_0_OPB_UARTLITE_0_IRQ)
#endif
...
#define XPAR_INTC_MAX_NUM_INTR_INPUT (XPAR_INTC_0_NUM_INTR_INPUTS)
#endif

#ifdef XPAR_UARTLITE_0_BASEADDR
#define XPAR_UART_0_BASEADDR		(XPAR_UARTLITE_0_BASEADDR)
#define XPAR_UART_0_INTR		(XPAR_UARTLITE_0_IRQ)
#endif
...
#define XPAR_INTC_MAX_NUM_INTR_INPUT (XPAR_XPS_INTC_0_NUM_INTR_INPUTS)
#define XPAR_INTC_0_KIND_OF_INTR (XPAR_XPS_INTC_0_KIND_OF_INTR)
#endif

#ifdef XPAR_XPS_UARTLITE_0_BASEADDR
#define XPAR_UART_0_BASEADDR		(XPAR_XPS_UARTLITE_0_BASEADDR)
#define XPAR_UART_0_INTR		(XPAR_XPS_UARTLITE_0_IRQ)
#endif
