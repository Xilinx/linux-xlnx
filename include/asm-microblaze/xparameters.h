...
#define XPAR_OPB_DDR_0_MEM0_BASEADDR	(CONFIG_XILINX_ERAM_START)
#define XPAR_OPB_DDR_0_MEM0_HIGHADDR	(CONFIG_XILINX_ERAM_START + CONFIG_XILINX_ERAM_SIZE - 1)
#endif
...
#define DDR_SDRAM_HIGHADDR	(XPAR_OPB_DDR_0_MEM0_HIGHADDR - \
				((XPAR_OPB_DDR_0_MEM0_HIGHADDR + 1 - XPAR_OPB_DDR_0_MEM0_BASEADDR) / 2))
#else
#define DDR_SDRAM_HIGHADDR	(XPAR_OPB_DDR_0_MEM0_HIGHADDR)
#endif
